...
Define the DirTree component, a collapsible directory tree sidebar for the graph view that mirrors the combo hierarchy from the dependency graph, with expand/collapse, sorting, indentation, and localStorage persistence.
