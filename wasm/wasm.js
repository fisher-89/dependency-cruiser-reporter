 ...
 * @param {string[] | null} [expandedDirs]
 * @returns {ProcessedGraph}
 */
function aggregate(content, maxNodes, expandedDirs) {
    const ptr0 = passStringToWasm0(content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(expandedDirs) ? 0 : passArrayJsValueToWasm0(expandedDirs, wasm.__wbindgen_malloc);
    var len1 = WASM_VECTOR_LEN;
    const ret = wasm.aggregate(ptr0, len0, maxNodes, ptr1, len1);
    if (ret[2]) {
